...
parent -wskaźnik do elementu rodzica z menu wyższego w
        hierarchi. Dzięki niemu możliwy jest powrót do
        poprzedniego menu
child - wskaźnik do pierwszego elementu menu potomnego
        dange elementu. Dzięki niemu możliwe jest przejście
        do menu niższego w hierarchi. Jeżeli elementu 
        zawiera wskaźnik na funkcję i zmienna type
        ma wartość PROGRAM to pole powinno mieć warotść
        NULL
next -  wskaźnik na kolejny element tego samego menu.
prev -  wskaźnik na poprzedni element tego samego menu.
menu_function - wskaźnik na funkcję zawierającą prgoram
