#include "Menu.h"
    ...
    */
    ...
    struct MenuItem menu1_1 = {"M1 Program 1", &menu0_1, 0, &menu1_2, 0, key_read, PROGRAM};
    struct MenuItem menu1_2 = {"M1 Program 2", &menu0_1, 0, 0, &menu1_1, 0, PROGRAM};
    struct MenuItem menu2_1 = {"M2 Program 1", &menu0_2, 0, &menu2_2, 0, one_led_blink, PROGRAM};
    struct MenuItem menu2_2 = {"M2 Program 2", &menu0_2, 0, 0, &menu2_1, stopwatch, PROGRAM};
    struct MenuItem menu3_1 = {"M3 Program 1", &menu0_3, 0, &menu3_2, 0, led_blink, PROGRAM};
    struct MenuItem menu3_2 = {"M3 Menu 1", &menu0_3, &menu1_1, 0, &menu3_1, 0, SUBMENU};

/*
Funkcja która wypisuje dwa lub jeden element menu
na wyświetlacz LCD.
*/
void write_menu() {
    /*chil
    ...
    */
    if(currentItem->prev != 0) {
        ...
        */
        ...
        /*
        Jeżeli nastąpiło przesunięcie kursora w górę lub przewinięcie
        ...
        */
        if(cursor_x == 1) {
            ...
            */
            ...
            /*
            Przewinięcie menu. Wyczyszczenie aktualnej zawartości
        ...
        /*
        Jeżeli nastąpiło przesunięcie kursora w dół lub przewinięcie
        menu, aktualnie wskazywany przez kursor element zmienia się
...
void menu_select() {
    ...
    /*
    Jeżeli aktualny element z założenia ma pozwolić na przejście do
    kolejnego menu oraz jeżeli element ten wskazuje na jakiś element 
    typu MenuItem to nastąpi przejście do tego elementu. 
    ...
    */
    if(currentItem->type == SUBMENU && currentItem->child != 0) {
        ...
        pierwszy element listy tworzącej menu niższe w hierarchii.
        */
...
void menu_back() {
    ...
    z jakimś innym elementem znajdującym się wyżej w hierarchii.
    */
    if(currentItem->parent != 0 && currentType == SUBMENU) {
        /*
        Cofnięcie do poprzedniego menu. Aktualny element zmienia się na
        odpowiadający mu element z menu wyższego w hierarchii.
        */
        ...
        zmiennej currentItem nie zmienia się. Aktualnie powrót działa w ten
        sposób że kursor pojawia się przy elemencie wskazującym na 
        program z którego właśnie wyszedł. Odkomentowanie poniższej linii
        pozwoliłoby na ustawienie kursora przy pierwszym elemencie menu do 
...
void menu_control(uint8_t key) {
    ...
    */  			
    if(currentType == SUBMENU) {
        ...
        /*
        Wywołanie odpowiedniej funkcji sterującej menu w zależności od tego
        który klawisz jest wciśnięty. Jeżeli nie jest wciśnięty żaden klawisz 
        odpowiadający za sterowanie funkcja nic nie robi.
        */
        switch(key) {
        ...
        /*
        Jeżeli wykonywany jest aktualnie program z menu dostępny jest tylko klawisz
...
(klawiatury, przerwań i LCD), odpowiadająca za inicjalizację menu.
*/
void menu_init() {

    /*
    Wyczyszczenie wyświetlacza, wypisanie dwóch pierwszych elementów najwyższego
