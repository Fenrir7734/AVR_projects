...
void LCD_init() {
	...
	*/
	...
	/*
	Wysłanie poszczególnych komend do wyświetlacza.
	*/
	...
	LCD_write_cmd(0b00000110);	//inkrementacja kursora, ekran nie zmienia położenia
...
/*
Funkcja odpowiadająca za wyczyszczenie linii na której znajduje
...
void LCD_clear_y(uint8_t y) {
	...
	*/
	...
	/*
	Powrót kursora do pozycji od której rozpoczęło się
	czyszczenie linii.
	*/
	LCD_set_cursor(cursor_x, y);
}
...
służy głównie do zmiany numeru klawisza na tablicę znaków w celu
